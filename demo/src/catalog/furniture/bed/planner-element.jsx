    ...
    return (
      <g transform={`translate(${-WIDTH / 2},${-DEPTH / 2})`}>
        <rect key="1" x="0" y="0" width={WIDTH} height={DEPTH}
          style={{ stroke: element.selected ? '#0096fd' : 'none', strokeWidth: "2px", fill: "none" }} />
        {/* <text key="2" x="0" y="0"
        ...
        <image width={WIDTH} height={DEPTH}
          style={{ stroke: element.selected ? '#0096fd' : '#000', strokeWidth: "2px", fill: "#84e1ce" }} href="catalog/furniture/bed/singleBed.jpg" ></image>
