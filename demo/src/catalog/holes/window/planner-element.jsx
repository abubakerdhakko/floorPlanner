...
export default {
  ...
  render2D: function (element, layer, scene) {
    const STYLE_HOLE_BASE = { stroke: "#000", strokeWidth: "3px", fill: "#fff" };
    ...
    return (
      <g transform={`translate(${-length / 2}, 0)`}>
        ...
        {/* <line key="2" x1={holeWidth / 2} y1={-10 - epsilon} x2={holeWidth / 2} y2={10 + epsilon} stroke="#000" strokeWidth="3px" fill="#fff" /> */}
      </g>
    );
  },
