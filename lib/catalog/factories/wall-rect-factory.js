...
var _wallRectFactory3d = require('./wall-rect-factory-3d');
  ...
  var wallElement = {
    ...
    render2D: function render2D(element, layer, scene) {
      ...
      return element.selected ? _react2.default.createElement(
        'g',
        null,
        _react2.default.createElement('rect', { x: '0', y: -half_thickness / 5, width: length, height: thickness / 5, style: STYLE_RECT_SELECTED }),
    ...
    render3D: function render3D(element, layer, scene) {
      return (0, _wallRectFactory3d.buildWall)(element, layer, scene, textures);
    },

    updateRender3D: function updateRender3D(element, layer, scene, mesh, oldElement, differences, selfDestroy, selfBuild) {
      return (0, _wallRectFactory3d.updatedWall)(element, layer, scene, textures, mesh, oldElement, differences, selfDestroy, selfBuild);
    }
